...
public class Mod1RM0 implements RMReturn{
    public RM getRM(VM vm){
        if(vm.is32bitAddress()){
            return new Memory32(vm, (int)vm.getRegister32(EAX) + vm.getSignedCode8(2), 1);
        }else{
            return new Memory16(vm, vm.getRegister16(EBX) + vm.getRegister16(ESI) + vm.getSignedCode8(2), 1);
        }
    }
}