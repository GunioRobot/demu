...
public class Mod2RM3 implements RMReturn{
    public RM getRM(VM vm){
        if(vm.is32bitAddress()){
            return new Memory32(vm, (int)vm.getRegister32(EBX) + vm.getSignedCode32(2), 4);
        }else{
            return new Memory16(vm, vm.getRegister16(EBP) + vm.getRegister16(EDI) + vm.getSignedCode16(2), 2);
        }
    }
}